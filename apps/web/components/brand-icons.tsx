...
/**
 * Third-party brand marks, kept in their own colours.
 *
 * This is the one sanctioned exception to the monochrome palette: everything else on the
 * site draws from the neutral tokens, but a package manager is recognised by its colour,
 * and repainting someone else's logo is both less legible and not ours to do.
 *
 * Yarn and Bun ship paths with no `fill`, which SVG defaults to black — invisible on a
 * dark background. Those specific paths are pinned to `currentColor` so they follow the
 * theme; every path that carried a real brand colour keeps it untouched.
 */
...
const Pnpm = (props: SVGProps<SVGSVGElement>) => (
  <svg viewBox="76.59 44 164.01 164" {...props}>
...
const Bun = (props: SVGProps<SVGSVGElement>) => (
  <svg viewBox="0 0 80 70" {...props}>
    ...
    <path
      fill="currentColor"
      d="M34.16 47a5.36 5.36 0 0 1 4.19-2.08 6 6 0 0 1 4 1.69c.23-.25.45-.51.66-.77a7 7 0 0 0-4.71-1.93 6.36 6.36 0 0 0-4.89 2.36 9.53 9.53 0 0 0 .75.73Zm3.93 3.19a7.42 7.42 0 0 1-4.45-2 9.52 9.52 0 0 1-3.11-5.05 1.2 1.2 0 0 1 .26-1 1.41 1.41 0 0 1 1.13-.51h12.34a1.44 1.44 0 0 1 1.13.51 1.19 1.19 0 0 1 .25 1 9.52 9.52 0 0 1-3.11 5.05 7.42 7.42 0 0 1-4.44 2Zm-6.17-7.4c-.16 0-.2.07-.21.09a8.29 8.29 0 0 0 2.73 4.37A6.23 6.23 0 0 0 38.09 49a6.28 6.28 0 0 0 3.65-1.73 8.3 8.3 0 0 0 2.72-4.37.21.21 0 0 0-.2-.09Z"
    />
