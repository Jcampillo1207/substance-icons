...
const Bot = /*#__PURE__*/ Object.assign(
  /*#__PURE__*/ React.forwardRef<SVGSVGElement, BotProps>(({
  size = 24,
  color = "currentColor",
  className,
  style,
  ...props
    ...
    {...props}
  ><path stroke={color || "currentColor"} strokeLinecap="square" strokeWidth="2" d="M12 8V4H8M2 14h2m16 0h2m-7-1v2m-6-2v2M4 8h16v12H4z"/></svg>
  )),
