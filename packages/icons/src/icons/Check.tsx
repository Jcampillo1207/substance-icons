...
const Check = /*#__PURE__*/ Object.assign(
  /*#__PURE__*/ React.forwardRef<SVGSVGElement, CheckProps>(({
  size = 24,
  color = "currentColor",
  className,
  style,
  ...props
    ...
    {...props}
  ><path stroke={color || "currentColor"} strokeLinecap="square" strokeWidth="2" d="M20 6 9 17l-5-5"/></svg>
  )),
