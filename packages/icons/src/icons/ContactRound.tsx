...
const ContactRound = /*#__PURE__*/ Object.assign(
  /*#__PURE__*/ React.forwardRef<SVGSVGElement, ContactRoundProps>(({
  size = 24,
  color = "currentColor",
  className,
  style,
  ...props
    ...
    {...props}
  ><path stroke={color || "currentColor"} strokeLinecap="square" strokeWidth="2" d="M16 2v2m1.915 18a6 6 0 1 0-12 0M8 2v2m8 8a4 4 0 1 1-8 0 4 4 0 0 1 8 0ZM3 4h18v18H3z"/></svg>
  )),
