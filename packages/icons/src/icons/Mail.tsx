...
const Mail = /*#__PURE__*/ Object.assign(
  /*#__PURE__*/ React.forwardRef<SVGSVGElement, MailProps>(({
  size = 24,
  color = "currentColor",
  className,
  style,
  ...props
    ...
    {...props}
  ><path stroke={color || "currentColor"} strokeLinecap="round" strokeWidth="2" d="m22 7-10 6L2 7m20 0V4H2v3m20 0v13H2V7"/></svg>
  )),
