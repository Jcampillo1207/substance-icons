...
const Star = /*#__PURE__*/ Object.assign(
  /*#__PURE__*/ React.forwardRef<SVGSVGElement, StarProps>(({
  size = 24,
  color = "currentColor",
  className,
  style,
  ...props
    ...
    {...props}
  ><path stroke={color || "currentColor"} strokeLinecap="round" strokeWidth="2" d="M15.44 7.75 12 2 8.56 7.751l-6.536 1.5 4.41 5.045-.598 6.674L12 18.34l6.166 2.632-.598-6.675 4.407-5.045z"/></svg>
  )),
