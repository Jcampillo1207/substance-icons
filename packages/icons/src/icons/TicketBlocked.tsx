...
export interface TicketBlockedProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  className?: string;
}
...
const TicketBlocked = /*#__PURE__*/ Object.assign(
  /*#__PURE__*/ React.forwardRef<SVGSVGElement, TicketBlockedProps>(({
  size = 24,
  color = "currentColor",
  className,
  style,
  ...props
    ...
    {...props}
  ><path stroke={color || "currentColor"} strokeLinecap="square" strokeWidth="2" d="M22 9V5H2v4a3 3 0 1 1 0 6v4h7m7-2h2m-3 5h4l3-3v-4l-3-3h-4l-3 3v4z"/></svg>
  )),
