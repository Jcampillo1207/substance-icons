...
export interface TicketFlagProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  className?: string;
}
...
const TicketFlag = /*#__PURE__*/ Object.assign(
  /*#__PURE__*/ React.forwardRef<SVGSVGElement, TicketFlagProps>(({
  size = 24,
  color = "currentColor",
  className,
  style,
  ...props
    ...
    {...props}
  ><path stroke={color || "currentColor"} strokeLinecap="square" strokeWidth="2" d="M22 9V5H2v4a3 3 0 1 1 0 6v4h7m5 2v-4m0 0v-6l6 3z"/></svg>
  )),
