...
const TicketPlus = /*#__PURE__*/ Object.assign(
  /*#__PURE__*/ React.forwardRef<SVGSVGElement, TicketPlusProps>(({
  size = 24,
  color = "currentColor",
  className,
  style,
  ...props
    ...
    {...props}
  ><path stroke={color || "currentColor"} strokeLinecap="square" strokeWidth="2" d="M9 12h3m3 0h-3m0 0v3m0-3V9M2 9a3 3 0 1 1 0 6v4h20v-4a3 3 0 0 1 0-6V5H2z"/></svg>
  )),
