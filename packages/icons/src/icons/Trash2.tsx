...
const Trash2 = /*#__PURE__*/ Object.assign(
  /*#__PURE__*/ React.forwardRef<SVGSVGElement, Trash2Props>(({
  size = 24,
  color = "currentColor",
  className,
  style,
  ...props
    ...
    {...props}
  ><path stroke={color || "currentColor"} strokeLinecap="square" strokeWidth="2" d="M19 6v16H5V6M3 6h18M8 6V2h8v4m-6 5v6m4-6v6"/></svg>
  )),
