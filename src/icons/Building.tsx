...
const Building = /*#__PURE__*/ Object.assign(
  /*#__PURE__*/ React.forwardRef<SVGSVGElement, BuildingProps>(({
  size = 24,
  color = "currentColor",
  className,
  style,
  ...props
    ...
    {...props}
  ><path stroke={color || "currentColor"} strokeLinecap="square" strokeWidth="2" d="M9 22v-4h6v4m-7-8v-2m4 2v-2m4 2v-2m0-4V6m-4 2V6M8 8V6m12-4v20H4V2z"/></svg>
  )),
