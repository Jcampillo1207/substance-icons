...
const Buildings = /*#__PURE__*/ Object.assign(
  /*#__PURE__*/ React.forwardRef<SVGSVGElement, BuildingsProps>(({
  size = 24,
  color = "currentColor",
  className,
  style,
