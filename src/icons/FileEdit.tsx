...
export interface FileEditProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  className?: string;
}
...
const FileEdit = /*#__PURE__*/ Object.assign(
  /*#__PURE__*/ React.forwardRef<SVGSVGElement, FileEditProps>(({
  size = 24,
  color = "currentColor",
  className,
  style,
