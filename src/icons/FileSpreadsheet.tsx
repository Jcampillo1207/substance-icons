...
const FileSpreadsheet = /*#__PURE__*/ Object.assign(
  /*#__PURE__*/ React.forwardRef<SVGSVGElement, FileSpreadsheetProps>(({
  size = 24,
  color = "currentColor",
  className,
  style,
  ...props
    ...
    {...props}
  ><path stroke={color || "currentColor"} strokeLinecap="square" strokeWidth="2" d="M13 2H4v20h16V9m-7-7h2l5 5v2m-7-7v7h7M8 14h2m4 0h2m-8 4h2m4 0h2"/></svg>
  )),
