...
const Key = /*#__PURE__*/ Object.assign(
  /*#__PURE__*/ React.forwardRef<SVGSVGElement, KeyProps>(({
  size = 24,
  color = "currentColor",
  className,
  style,
  ...props
    ...
    {...props}
  ><path stroke={color || "currentColor"} strokeLinecap="square" strokeWidth="2" d="m14 7 3 3m-7.6.6L2 18v2l2 2h3v-3l2.707-.293.586-2.414 2.45-2.45m0 0L14.2 15.3l1.7 1.7 5.4-5.4a2.5 2.5 0 0 0 0-3.4l-5.5-5.5a2.5 2.5 0 0 0-3.4 0L7 8.1z"/></svg>
  )),
