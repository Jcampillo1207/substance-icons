...
const ListTree = /*#__PURE__*/ Object.assign(
  /*#__PURE__*/ React.forwardRef<SVGSVGElement, ListTreeProps>(({
  size = 24,
  color = "currentColor",
  className,
  style,
  ...props
    ...
    {...props}
  ><path stroke={color || "currentColor"} strokeLinecap="square" strokeWidth="2" d="M8 5h13m-8 7h8m-8 7h8M3 12h5m-5 0V5m0 7v7h5"/></svg>
  )),
