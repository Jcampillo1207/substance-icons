...
const Signal = /*#__PURE__*/ Object.assign(
  /*#__PURE__*/ React.forwardRef<SVGSVGElement, SignalProps>(({
  size = 24,
  color = "currentColor",
  className,
  style,
  ...props
    ...
    {...props}
  ><path stroke={color || "currentColor"} strokeLinecap="square" strokeLinejoin="round" strokeWidth="2" d="M2 20h.01M7 20v-4m5 4v-8m5 8V8m5-4v16"/></svg>
  )),
