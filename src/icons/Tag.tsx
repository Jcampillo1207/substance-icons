...
const Tag = /*#__PURE__*/ Object.assign(
  /*#__PURE__*/ React.forwardRef<SVGSVGElement, TagProps>(({
  size = 24,
  color = "currentColor",
  className,
  style,
  ...props
    ...
    {...props}
  ><path fill={color || "currentColor"} stroke={color || "currentColor"} strokeLinecap="round" strokeWidth="2" d="M7.5 8a.5.5 0 1 0 0-1 .5.5 0 0 0 0 1Z"/></svg>
  )),
