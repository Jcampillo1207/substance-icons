...
const Tickets = /*#__PURE__*/ Object.assign(
  /*#__PURE__*/ React.forwardRef<SVGSVGElement, TicketsProps>(({
  size = 24,
  color = "currentColor",
  className,
  style,
  ...props
    ...
    {...props}
  ><path stroke={color || "currentColor"} strokeLinecap="square" strokeWidth="2" d="M4.5 8H2v13h4M4.5 8 16 2l2 6M4.5 8H6m12 0h4v13H6M18 8H6m0 0v2m0 3v3m0 5v-2"/></svg>
  )),
