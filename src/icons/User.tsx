...
const User = /*#__PURE__*/ Object.assign(
  /*#__PURE__*/ React.forwardRef<SVGSVGElement, UserProps>(({
  size = 24,
  color = "currentColor",
  className,
  style,
  ...props
    ...
    {...props}
  ><path stroke={color || "currentColor"} strokeLinecap="square" strokeWidth="2" d="M12 13a5 5 0 1 0 0-10 5 5 0 0 0 0 10Zm0 0a8 8 0 0 1 8 8m-8-8a8 8 0 0 0-8 8"/></svg>
  )),
